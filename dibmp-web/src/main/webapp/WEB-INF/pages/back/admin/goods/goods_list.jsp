				...
				<table class="table table-condensed">
					<thead>
						<tr>
							...
							<th class="text-center" style="width:10%;">商品重量（g）</th>
							<th class="text-center" style="width:10%;">入库时间</th>
							<th class="text-center" style="width:10%;">库存量</th>
							<th class="text-center" style="width:10%;">记录人员</th>
					...
					<c:forEach  items= "${allGoods}" var = "goods">
					    ...
					    <td class="text-left">${goods.gid}</td>
							...
							<td class="text-center"> <fmt:formatDate value="${goods.lastin}"   pattern="yyyy-MM-dd hh:mm:ss" type="date"/></td>
							<td class="text-center"><span id="storage-${goods.wiid}" style="cursor:pointer;">${goods.stornum}</span></td>
							...
							<shiro:hasAnyRoles name="salegoods">			
