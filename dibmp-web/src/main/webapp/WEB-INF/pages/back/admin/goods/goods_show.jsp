					...
					<div>
						<table class="table table-condensed" >
							<tr>
								...
								<td><span>${allGoods.gid}</span></td>
								<td><strong>商品图片：</strong></td>
							</tr>
							<tr>
								<td><strong>商品名称：</strong></td>
								<td><span>${allGoods.name}</span></td>
							...
							<tr>
								...
								<td>${allGoods.stornum}（
									<button id="storage-${allGoods.wiid}"  class="btn btn-danger btn-xs">
							...
							<tr>
								...
								<td>${allGoods.weight}</td>
							</tr>
							<tr>
								<td><strong>最后入库日期：</strong></td>
								<td>  <fmt:formatDate value="${allGoods.lastin}"   pattern="yyyy-MM-dd hh:mm:ss" type="date"/></td>
							</tr>
							<tr>
								<td><strong>备注信息：</strong></td>
								<td><pre class="pre-scrollable" style="width:700px;height:150px;">${allGoods.note}</pre></td>
							</tr>
						</table>
					</div>
